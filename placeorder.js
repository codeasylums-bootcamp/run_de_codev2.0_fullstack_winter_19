    ...
    .then((response)=>{
        ...
        for(let i=0;i<siz;i++){
            ...
            {   k=i;
               ...
               <table style="width:100%; margin-left: 20%; background-color: #20c997;border-radius:20%">   
            <tr style="border: 5px solid black; ">
            <th >select</th>
             <th style="border: 5px solid black;">Name of Item</th>
                <th style="border: 5px solid black;">Price of Item</th> 
                <th style="border: 5px solid black;">Quantity</th>
                
            </tr>
            <tr style="border: 5px solid black; ">
            <td style="border: 5px solid black; "> <div class="col-lg-2"><input type="checkbox"  autocomplete="off" id="c${ka}"></div></td>
                <td style="border: 5px solid black;">${response.data[i].menu[j][0]}</td>
                <td style="border: 5px solid black;">${response.data[i].menu[j][1]}</td>
                <td style="border: 5px solid black;"><input type="number" placeholder="" value=0 style=" width:100%;padding: 12px 20px;margin: 8px 0;box-sizing: border-box; "id="p${ka}"></td>
             <br>  
            </tr>
               `
